...
datos <- select(datos_2020, P13STGBS_A, P13STGBS_B, p13st_c, p13st_d, p13st_e, p13st_f, edad, sexo )
...
mutate(confianza_gobierno = car::recode(.$confianza_gobierno, recodes =c("1 = 'Mucho'; 2 = 'Algo';
                                            3 = 'Poca'; 4 = 'Ninguna'; c(-1, -2, -3, -4, -5) = NA"))) %>%
mutate(confianza_judicial = car::recode(.$confianza_judicial, recodes = c("1 = 'Mucho'; 2 = 'Algo';
                                            3 = 'Poca'; 4 = 'Ninguna'; c(-1, -2, -3, -4, -5) = NA"))) %>%
